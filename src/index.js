...
const findOrganization = (queryString) => (
    callVIAF(getOrganizationLookupURI(queryString), queryString)
);
...
const getOrganizationLookupURI = (queryString) => (
    getEntitySourceURI(queryString, 'local.corporateNames')
);
const getTitleLookupURI = (queryString) => (
    getEntitySourceURI(queryString, 'local.uniformTitleWorks')
)
